...
export class BrightRiskToken_proxy extends ethereum.SmartContract {
  static bind(address: Address): BrightRiskToken_proxy {
    return new BrightRiskToken_proxy("BrightRiskToken_proxy", address);
  }
